...
def main():
    ...
    parser.add_argument("--verbose", action="store_true", help="Show cooldown provenance and observation time")
    ...
    list_parser.add_argument("--verbose", action="store_true", help="Show cooldown provenance and observation time")
