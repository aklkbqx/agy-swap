...
func tuiActions(state *tuiState) []tuiAction {
	...
	return []tuiAction{
		...
		{ID: "split-widen", Label: "Widen accounts pane", Description: "Increase left accounts pane width", Shortcut: "]", Section: "Layout", Enabled: true},
		{ID: "split-narrow", Label: "Narrow accounts pane", Description: "Decrease left accounts pane width", Shortcut: "[", Section: "Layout", Enabled: true},
		{ID: "split-reset", Label: "Reset pane split", Description: "Reset layout split to default width", Shortcut: "=", Section: "Layout", Enabled: true},
